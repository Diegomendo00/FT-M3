...
async function problemA() {
  ...
  // esta opcion pasaria dentro de los test pero no es correcta, se debe utilizar el Promise.all
  // await readFileAsync("poem-two/stanza-01.txt")
  // await readFileAsync("poem-two/stanza-02.txt")

  await Promise.all([
    readFileAsync("poem-two/stanza-01.txt"),
    readFileAsync("poem-two/stanza-02.txt"),
  ]);
  console.log("done");
}
