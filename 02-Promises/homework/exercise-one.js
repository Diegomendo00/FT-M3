...
function problemC () {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * C. lee & loggea el poema stanza dos y *DESPUES* lee & loggea
...
function problemD () {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * D. loggea el poema stanza cuatro o un error si llega a ocurrir
   *
   */
...
function problemE () {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * E. Lee y loggea el poema stanza tres y *DESPUES* lee y loggea la
...
function problemF () {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * F. Lee & loggea el poema stanza tres y *DESPUES* lee y loguea la
...
//   });
  ...
  // promise version
   ...
   promisifiedReadFile("poem-one/stanza-03.txt")
		...
		.then(stanza => blue(stanza))
		.catch(err => magenta(new Error(err)))
		.finally( () => console.log("done"))// finally se ejecuta siempre sin importar lo que pase anteriormente(si se cumple o no la promesa)
}
